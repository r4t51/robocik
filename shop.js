  ...
  const CATALOG = [
    {
      id: "life",
      name: "Życie",
      blurb: "Dostajesz jedno życie więcej.",
      cost: 6,
      once: false,
    },
    {
      id: "jump",
      name: "Długi skok",
      blurb: "Skok trwa dłużej. Łatwiej przeskoczyć ściankę.",
      cost: 7,
      once: true,
    },
    {
    ...
    },
    {
      id: "shield",
      name: "Tarcza",
      blurb: "Jeden raz robocik cię nie zrani.",
      cost: 8,
      once: false,
    },
    {
      id: "slow",
      name: "Wolne roboty",
      blurb: "Czerwone i białe oczy idą wolniej.",
      cost: 8,
      once: true,
    },
  ];
